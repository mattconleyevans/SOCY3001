...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://https://socy3001.onrender.com/api/query", {
        method: 'POST',
        headers: {
      ...
      <Container fluid className="p-4 bg-light">
        ...
        {showAbout && (
            <div className="about-modal">
              ...
              <p>This tool has been created as part of a research project in the School of Sociology at the Australian National University studying how AI can be used to understand and engage
                with place.<br /><br />
                The AI has been trained to take on the character of Justice Robert Hope Park, also known as Watson
                Woodlands, a 19-hectare woodland area on the edge of Canberra. The AI has been trained to respond to queries in first person from the park's perspective.<br /><br />
                The AI has access to a corpus of information about the park, including 3000 photographs, news coverage,
                government documents, satellite images, weather data, visitor reviews, and citizen science observations. It uses this corpus of information to personify the park and attempt to interpret its experiences and desires in response to queries. It will also present 6 images relevant to each query from its image database.<br /><br />
        ...
        {showArchive && (
            <div className="about-modal">
              ...
              <li><a
                ...
                <li><a href="https://jhp-ai-socy3001.s3.ap-southeast-2.amazonaws.com/Documents/EnvironmentalOffsets.pdf"
                       target="_blank"
